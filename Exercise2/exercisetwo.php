...
2. Read the following sentence carefully
    ...
    iii. He wants to keep the customer username and email throughtout the duration of the application until they sign out to avoid creating more functions that 
    will fetch for the username and email all the time
...
Nb. He wants all the functions to display error and success messages containing the values from the form within their respective statement when possible and for 
now, he wants you to assume or use static values.
-->
