...
2. Read the following sentence and create about 6 variables (3 strings / 3 int values)

    A user named Kelvin Hart came to Dubai to perform on 4th April 2016. He is like 5 feet tall and I guess he is 30 years old. His show was restricted. users between the ages of 18 - 49 only could attend. users below the 17 were told to wait for their parents outside and users above 50 were asked to wait in the car.   
...
$comedy_show = array("performer" => "$performer_name", "performer_height" =>"$hieght", "age_allowed" => "$user_allowed");
...
echo $comedy_show['performer_height'];
echo "<br><br>";
?>
<?php
